...
def prime_powers_intlist(Py_ssize_t B):
    ...
    EXAMPLES::
        ...
        sage: from ratmodform.misc_list import prime_powers_intlist
...
def extend_multiplicatively(IntList a):
    ...
    EXAMPLES::
        ...
        sage: from ratmodform.misc_list import extend_multiplicatively
...
def extend_multiplicatively_generic(list a):
    ...
    EXAMPLES::
        ...
        sage: from ratmodform.misc_list import extend_multiplicatively_generic
